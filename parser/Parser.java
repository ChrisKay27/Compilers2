...
public class Parser {
    ...
    private final Supplier<Integer> lineNumber;
    ...
    public Parser(Scanner scanner, Consumer<String> lineTraceOutput, Consumer<String> errorOutput, Supplier<Integer> lineNumber) {
